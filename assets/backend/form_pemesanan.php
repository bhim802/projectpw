                            ...
                            <div class="text-center mb-4">
                                <span class="badge-game shadow-sm">
                                    <span class="text-primary fw-bold"><?php switch ($game_dipilih) {
                                        case 'PUBG':
                                            echo "<img src='/projectpw/assets/payment-logo/PUBG.png' alt='pubg' class='logo-name'> ";
                                            break;
                                             case 'MobileLegends':
                                            echo "<img src='/projectpw/assets/payment-logo/MLBB.png' alt='mlbb' class='logo-name'> ";
                                            break;
                                            case 'Honor-Of-Kings':
                                            echo "<img src='/projectpw/assets/payment-logo/HOK.png' alt='hok' class='logo-name'> ";
                                            break;
                                            case 'Free-Fire':
                                            echo "<img src='/projectpw/assets/payment-logo/FF.png' alt='ff' class='logo-name'> ";
                                            break;
                                              } ?> 
                                    </span>
                                </span>
